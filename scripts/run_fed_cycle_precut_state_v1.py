    ...
    for s in states:
        for val in (False,True):
            ...
            contrasts.append({
                ...
                "weighted_median_risk3_trough_month":wmedian(g.RISK3_MEDIAN_TROUGH_MONTH,w),
                "weighted_median_late_trough_share":wmedian(g.RISK3_LATE_TROUGH_SHARE,w),
                "weighted_mean_late_trough_share":float(np.average(g.RISK3_LATE_TROUGH_SHARE,weights=w)),
            })
